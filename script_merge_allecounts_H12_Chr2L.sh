...
#########################
# merge allelecounts with H12 stats for chr 2L

# read files
allelecount_file="RESULTS_allelecount_Chr2L.tsv"
h12_coluzzii_file="H12stats_95qoutliers_coluzzii_Chr2L.tsv"
h12_gambiae_file="H12stats_95qoutliers_gambiae_Chr2L.tsv"
output_file="allelecount_with_H12_chr2L.txt"
