...
#########################
# merge allelecounts with H12 stats for chr X

# read files
allelecount_file="RESULTS_allelecount_ChrX.tsv"
h12_coluzzii_file="H12stats_95qoutliers_coluzzii_ChrX.tsv"
h12_gambiae_file="H12stats_95qoutliers_gambiae_ChrX.tsv"
output_file="allelecount_with_H12_chrX.txt"
